...
AN1 Engine is a public API and benchmark suite for the AN1 accelerated attention layer, delivering validated 7.21×+ speedup on NVIDIA H100 NVL GPUs. Provides accelerated implementations of attention and matrix multiplication operations with automatic fallback to baseline PyTorch implementations.
...
| AN1 backend (private) | 1.346        | 12,171,685   | 408.41 | **7.21×+**          |
